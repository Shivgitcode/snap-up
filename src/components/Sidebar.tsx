        ...
        <div className=" bg-[#334155] py-[32px] px-[16px] min-w-[300px]">
            <nav className="flex flex-col justify-between min-h-full">
                <div>
                    ...
                    <ul>
                        {side.map(el => {
                            return <li><Button variant={"ghost"} className="flex items-center gap-5 mb-10 text-white hover:bg-transparent hover:text-white"><el.icon /><span>{el.name}</span></Button></li>
                        })}
                    </ul>
