    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[425px] bg-[#1e2530] text-white">
                <DialogHeader>
                    <DialogTitle className="text-xl font-semibold">New Monitor</DialogTitle>
                    <DialogDescription className="text-gray-400">
                        Advanced HTTP settings and SSL certificate expiration alerts are available on paid accounts only.
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="Enter monitor name" {...field} className="bg-[#2a3441] border-gray-600" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="https://example.com" {...field} className="bg-[#2a3441] border-gray-600" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
